...
`artifacts/releases/MoneyMoves-Toolkit-0.15.0.ccx`
...
3. From the repository root, verify the package checksum:
   ...
   /usr/bin/shasum -a 256 -c MoneyMoves-Toolkit-0.15.0.ccx.sha256
   ```
...
4. Normally, install the `.ccx` through Adobe's Unified Plugin Installer Agent:
   ...
   ```sh
   CCX="/Users/davidgajdamaka/Desktop/code/moneymoves-plugin-set/artifacts/releases/MoneyMoves-Toolkit-0.15.0.ccx"
